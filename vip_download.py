...
async def download_mp3(music_info):
    ...
    if not os.path.exists(f'./musics/{file}'):
        ...
        headers = {
            ...
            "Cookie": "MUSIC_U=6xxff42e44dbab42ef535264fac1515d3e77a0e92573ef730bf880b29f9097d50931c3a9fbfe3df2"
        }
        data = {
            "ids": [song_id],
            "br": 320000,
        ...
        async with httpx.AsyncClient() as client:
            try:
                r = await client.post(api, headers=headers, data=data, timeout=8)
                ret_data = r.json()
...
if __name__ == "__main__":
    async def demo():
        print(await download_mp3({'song_id': 1488780845, 'title': 'Piu Piu Piu', 'singer': '拼音师'}))
